...
public:
    ...
    // ----- Constructor -----
    RotaryEncoder(uint8_t pin1, uint8_t pin2, uint8_t buttonPin = NULL, LatchMode mode = LatchMode::FOUR0);
...
private:
    uint8_t _pin1, _pin2, _buttonPin; // Arduino pins used for the encoder.
